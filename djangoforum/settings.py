...
SECRET_KEY = 'django-insecure-1m95-mylf7)g%&*c8#((x*(qkv)szgmm$&46i0ev#2cx9&@i(k'
...
cloudinary.config( 
  cloud_name = "dgvmekrma", 
  api_key = "163692872252347", 
  api_secret = "UOxYeyigEzMlp1u3QZ63v-W5OVE" 
)
